<?php
    ...
    class PDF extends FPDF{   
        ...
        function Header(){                         
            ...
            $this->Cell(190, 5, utf8_decode("KARDEX DE PROVEEDORES"),0,1, 'C',0);                                                                                                                                        
    ...
    $saldo=0;
    $repetido=0;
    $consulta=pg_query("select * from proveedores where id_proveedor='$_GET[id]' order by id_proveedor asc");    
        while($row=pg_fetch_row($consulta)){
            $consulta1=pg_query("select * from c_pagarexternas where id_proveedor='$_GET[id]' and fecha_actual between '$_GET[inicio]' and '$_GET[fin]' order by id_c_pagarexternas asc");
            ...
            while($row1=pg_fetch_row($consulta1)){
                ...
                $pdf->Cell(45, 6, utf8_decode($row1[8]),0,0, 'C',0);   
