    ...
    class PDF extends FPDF{   
        ...
        function Header(){                         
            ...
            while($row=pg_fetch_row($sql)){                                                                                    
                ...
                $this->SetX(1);                                  
                $this->Cell(100, 6, utf8_decode('Teléfono: '.$row[24]),0,0, 'L',1);                
                $this->Cell(105, 6, utf8_decode('Celular: '.$row[25]),0,1, 'L',1);                
                $this->SetX(1);                                                  
                $this->Cell(100, 6, utf8_decode('CI/RUC Responsable: '.$row[38]),0,0, 'L',1);                                                
                $this->Cell(105, 6, utf8_decode('Responsable: '.$row[36].' '.$row[37]),0,0, 'L',1);                         
                $this->temp1 = $row[10];                
                $this->temp2 = $row[11];
                $this->temp3 = $row[12];
                $this->temp4 = $row[13];
